...
class VoteTableViewSet(AgentWriteViewSet):
    ...
    def get_summary(self, request, pk=None):
        ...
        total_votes = (
            vote_table.vote_entries.aggregate(total=Sum("votes_count"))["total"] or 0
        )
        ...
        data = {
            ...
            "turnout_percentage": (total_votes / vote_table.total_voters * 100)
            if vote_table.total_voters > 0
            else 0,
